...
require("../../../db.php");
    ...
    $id=$_GET["edit"];
    $query = $con -> query("SELECT * from skills where id= '$id'");
...
if(isset($_POST['submit'])){
    ...
    move_uploaded_file($imageTmpName, $imagePath);
        ...
        $query=mysqli_query($con,"UPDATE skills SET id='$id', experience='$experience',
        image='$imagePath', level='$level' WHERE id=$id ");
        if($query){
