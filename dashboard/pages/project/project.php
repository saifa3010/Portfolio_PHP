                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align: center;" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Link</th>
                      <th style="text-align: center;" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Brief</th>
                  ...
                  <?php foreach($data as $row): ?>
                    ...
                    <td style="text-align: center;">
                      ...
                      <td style="text-align: center;">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['link'] ?></p>
                      </td>
                      ...
                      <td style="text-align: center;">
                      <a href="project/edit.php?edit=<?php echo $row['id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-Link="Edit user">
                          Edit
                        </a>
                        <a href="project/delete.php?delete=<?php echo $row['id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-Link="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
