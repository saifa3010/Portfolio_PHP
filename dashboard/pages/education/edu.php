...
<form action="education/create.php">
                  ...
                  <?php foreach($data as $row): ?>
                    ...
                    <td style="text-align: center;">
                      ...
                      <td style="text-align: center;">
                        ...
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['certificates'] ?></p>
                      </td>
                     
                      <td style="text-align: center;">
                       
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['enterprise'] ?></p>
                      ...
                      <td style="text-align: center;">
                        <a href="education/edit.php?edit=<?php echo $row['id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                        <a href="education/delete.php?delete=<?php echo $row['id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
