...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = mysqli_query($con, "SELECT * FROM experience WHERE position= '$position'");
        if (mysqli_num_rows($query) > 0) {
            echo "<h1 style='margin-left: 500px;'>Already exists</h1>";
        } else {
            $insert = mysqli_query($con, "INSERT INTO experience (position, company, description,start_date,end_date) 
                           VALUES ('$position', '$company', '$description','$start_date','$end_date')");
